...
- Extended Module-LWE with $$\adv_0 = \tau$$ and $$\chi' = \set{0}$$: The authors of {% cite CTRSA:BJRW21 %} utilises [First-are-errorless variant of LWE](/first-are-errorless-lwe/) as an intermediate step in the reduction from M-LWE to Extended LWE, which itself is an intermediate result to reduce to [Binary-Secret Module-LWE](/binary-secret-lwe/).
