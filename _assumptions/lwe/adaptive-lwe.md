...
In Section 7 of {% cite STOC:AbrMalRoy25 %}, Abram, Malavolta, and Roy provide an attack on the aforementioned optimistic choice of parameters. They exploit the fact that $$\vec{x}$$ can be chosen after $$\set{\mathcal{A}_i}_{i \in [k]}$$.
