...
_Hint-MLWE$$^{\ell,(\mathcal{D}_{\mathbf{c}_i,\mathbf{\Sigma}_i})_{i \in [\ell]}, \mathcal{\mathcal{H}}}_{n,m,q,\mathcal{D}_{\mathbf{c},\mathbf{\Sigma}},\mathcal{R}}$$ is at least as hard as [short secret M-LWE](/lwe/#module-lwe)$$_{n,m,q,\mathcal{D}_\sigma,\mathcal{R}}$$. The private variables follow (elliptical) Gaussian distributions due to convolution of discrete Gaussian distribution._
