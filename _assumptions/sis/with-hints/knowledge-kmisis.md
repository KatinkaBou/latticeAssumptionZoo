...
### Knowledge $$k$$-M-ISIS$$_{n,q,\beta,\beta^{*},m,N,w,s}$$ {#knowledge-k-m-isis}
...
_then there exists a ppt extractor $$\mathcal{E}_{\adv}$$ that -- with access to the adversary's randomness -- outputs short $$\set{c_g}$$ s.t._
